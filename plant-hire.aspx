<%@ Page Language="C#" AutoEventWireup="true" CodeFile="plant-hire.aspx.cs" Inherits="plant_hire" %>
...
<html class="no-js" lang="en">
	<head>
		...
		<title>Amawakawaka Projects :: Plant Hire</title>
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="overview-wrapper">
						    <h3> Plant Hire </h3>
                            <p>Amawakawaka Plant & Transport offers plant hire solutions within the construction sector with first-hand experience in earth moving and logistics. Reliability is one of our company's pillars to our clients.</p>
                            <p><strong>Amawakawaka Plant & Transport has further immediate access to the following equipment:</strong></p>
                            <ul class="marker-list">
								<li>Tipper Trucks - 10m³</li>
								<li>Grader - 140H</li>
								<li>Roller - 12T</li>
								<li>Excavators - 20-23 Tons</li>
								<li>TLB's - 2x4 & 4x4</li>
								<li>Lowbed</li>
								<li>Water Tankers - 8 000L-14 000L</li>
								<li>Paver</li>
								<li>10T Crane Truck</li>
							</ul> 
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="overview-image">
                        	<img src="img/about/img-06.jpg" alt="overview"><br /><br />
                            <img src="img/about/img-07.jpg" alt="overview">
                        </div>
				    </div>
				    <!-- End Column -->
				</div>
