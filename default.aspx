...
<html class="no-js" lang="en">
	<head>
		...
		<title>Amawakawaka Projects</title>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="layer-2 wow fadeInUp" data-wow-delay="0.5s">
                                                <p style="color: #FFF;">Welcome to Amawakawaka Projects</p>
                                            </div>
                                            <!-- layer 1 -->
                                            <div class="layer-1 wow fadeInUp" data-wow-delay="0.3s">
                                                <h2 class="title2" style="color: #FFF;">What Drived Our Business?</h2>
                                            </div>
                                            <!-- layer 2 -->
                                            <div class="layer-2 wow fadeInUp" data-wow-delay="0.5s">
                            ...
                            <div class="display-table-cell">
                                <div class="container">
                                    <div class="row">
                                         <div class="col-md-12">
                                             <div class="layer-2 wow fadeInUp" data-wow-delay="0.5s">
                                                <p style="color: #FFF;">HOW WE WORK.</p>
                                            </div>
                                            <!-- layer 1 -->
                                            <div class="layer-1 wow fadeInUp" data-wow-delay="0.3s">
                                                <h2 class="title2" style="color: #FFF;">Our Business Approach</h2>
                                            </div>
                                            <!-- layer 2 -->
                                            <div class="layer-2 wow fadeInUp" data-wow-delay="0.5s">
                                                <p style="color: #FFF;">Amawakawaka Projects is supported by the latest quality management systems and a young, dynamic and agile team with the necessary experience to perform every aspect of its operations.</p>
                                            </div>
                                            <!-- layer 3 -->
                                            <div class="layer-3 wow fadeInUp" data-wow-delay="0.7s">
                                                <a href="#" class="ready-btn left-btn " >Our Services</a>
                            ...
                            <div class="display-table-cell">
                                <div class="container">
                                    <div class="row">
                                         <div class="col-md-12">
                                            <div class="layer-2 wow fadeInUp" data-wow-delay="0.5s">
                                                <p style="color: #FFF;">WHERE WE ARE HEADING</p>
                                            </div>
                                            <!-- layer 1 -->
                                            <div class="layer-1 wow fadeInUp" data-wow-delay="0.3s">
                                                <h2 class="title2" style="color: #FFF;">Our Vision & Mission</h2>
                                            </div>
                                            <!-- layer 2 -->
                                            <div class="layer-2 wow fadeInUp" data-wow-delay="0.5s">
                                                <p style="color: #FFF;">To serve the country and its people in the infrastructure, building, plant and equipment hire space.  In all our engagements, we strive to contribute in a practical and meaningful way towards service delivery.</p>
                                            </div>
                                            <!-- layer 3 -->
                                            <div class="layer-3 wow fadeInUp" data-wow-delay="0.7s">
                                                <a href="#" class="ready-btn left-btn " >Our Services</a>
